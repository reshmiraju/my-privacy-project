...
public class user_home extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.profile) {
            ...
            Intent i=new Intent(getApplicationContext(),Search_frnd.class);
            startActivity(i);
            ...
            Intent i=new Intent(getApplicationContext(),Post_photo.class);
            startActivity(i);
        } else if (id == R.id.view) {
            Intent i=new Intent(getApplicationContext(),View_post.class);
            startActivity(i);
            ...
            Intent i=new Intent(getApplicationContext(),Pvcy.class);
            startActivity(i);

        } else if (id == R.id.cmplt) {
